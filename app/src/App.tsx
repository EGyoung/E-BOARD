...
import "./styles.css";
import { RoamPlugin, SelectionPlugin, ClearPlugin, PicturePlugin, HotkeyPlugin, DrawArrowPlugin, DrawLinePlugin, DrawCirclePlugin } from "@e-board/board-core";
...
const App: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    const loadPlugins = async () => {
      const plugins = [HotkeyPlugin, RoamPlugin, SelectionPlugin, DrawShapePlugin, DrawArrowPlugin, DrawLinePlugin, DrawCirclePlugin, ClearPlugin, PicturePlugin, EraserPlugin, BoardAIAssistantPlugin];
